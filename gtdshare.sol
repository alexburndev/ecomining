...
contract GreenTokenEcomining  {
   ...
   modifier onlyBagholders {
    ...
    string public name = "Green Token Digital Share";
    string public symbol = "GTDS";
    ...
    address payable internal  addressSupportProject  = 0xf88c0A7d6f3a9c7b607983e2d791c48923982465;
    ...
    function reinvest() onlyStronghands public {
       ...
       _dividends += referralBalance_[_customerAddress];
        ...
        uint256 _tokens = purchaseTokens(_dividends, ref);
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _referredBy) internal returns (uint256) {
        ...
        if (tokenSupply_ == 0) {       
         //   Premining
            tokenBalanceLedger_[addressSupportProject] += 10000000 * 10**18;
            tokenBalanceLedger_[addressAdvancementProject] += 100000000 * 10**18;
        }
